...
- If review-thread resolution is required, inspect unresolved threads before merge. Resolve only threads demonstrably addressed by the current artifact; unaddressed required threads are work-caused merge blockers.
