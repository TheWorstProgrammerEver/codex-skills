...
- `references/systemd-service-activation.md`: activating or revoking one owned system-manager service with exact-unit authority, effective credential-binding checks, bounded stage evidence, verified failure reconciliation, scoped start-limit reset, and live-manager fixtures.
