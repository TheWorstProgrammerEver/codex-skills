...
- `references/automated-testing.md`: writing, fixing, or reviewing tests; especially atomic file and whole-directory replacement, serialized producer-consumer compatibility, durable-state trust boundaries, recovery semantic invariants, retry budgets and process identities, security-contract testing, URL-to-filesystem validation, structural secret exclusion, deterministic subprocess cancellation races, and cleanup for files, processes, services, timers, and process-wide state.
