---
name: coding-style
description: Apply Ryan Hayward's coding and review preferences. Use for work including features, fixes, refactors, stack choices, accessibility, tests, security, example/fixture boundaries, paginated authorization evidence, structured-config mutation, artifact fixture conformance, native lockfile portability, resumable artifact caches, remote promotion, launcher verification, filesystem bundle modes, stale locks, destructive block-device workflows, readiness-gated secret hydration, prompt-driven external effects, atomic replacement, transactional sensitive-file migration, durable-state trust boundaries, recovery validation, derived-artifact replay, retry-budget, stable-clock, process-identity, and Codex error-projection semantics, URL-to-filesystem validation, subprocess lifecycle, systemd timer re-arming and TTY routing, transient live checkpoint gates, cancellation settlement and orchestration propagation, GitHub Actions job containers, Bash, reviews, templates, React, TypeScript, and validation planning.
---
