...
- `references/automated-testing.md`: writing, fixing, or reviewing tests; especially security-contract testing, URL-to-filesystem validation, structural secret exclusion, and cleanup for files, processes, services, timers, and process-wide state.
