# __APP_DISPLAY_NAME__ Environment Setup

Use this checklist when deploying __APP_DISPLAY_NAME__ to Netlify and a hosted Supabase project. Keep placeholder values in this file; do not commit real secrets, credential values, private hostnames, local IP addresses, or device-specific identifiers.
...
- Passkeys/WebAuthn, when enabled:
  ...
  - RP display name: `__APP_DISPLAY_NAME__`.
